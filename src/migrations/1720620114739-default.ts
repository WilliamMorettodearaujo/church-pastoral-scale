...
export class Default1720620114739 implements MigrationInterface {
  name = "Default1720620114739";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "pastorals_users" ADD CONSTRAINT "FK_dd882b2fb5e80a344b1e1fe750e" FOREIGN KEY ("usersId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
  }
